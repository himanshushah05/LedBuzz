...
#define FIREBASE_HOST "ledbuzz-ea4c8-default-rtdb.asia-southeast1.firebasedatabase.app/" //Without http:// or https:// schemes
#define FIREBASE_AUTH "A8t1ELcuahNOHAhbdXBMuGEMVlqPwkVXFhDNSQO0"
...
int LED_COUNT = 8;
int k;
String uid="Ck3bAW4ZAsXWtGOXTEDvHYSm3l33";
...
void loop(){
    ...
    for(int i=0;i<10;i++)
    {
      ...
      (subs[i]+" "+"Class Alert").toCharArray(Display_String,100);
    }
//    Serial.print("RPM: ");
//    Serial.println(rpm);
